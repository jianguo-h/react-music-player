...
class PlayOperate extends Component {
  ...
  render() {
    ...
    const opearteClass = showDetail
      ? 'play-operate play-detail'
      : 'play-operate';
    ...
    return (
      <div className={opearteClass}>
        <span
          className="prev"
          onClick={this.changePlay.bind(this, 'prev')}
        ></span>
        <span
          className={playClass}
          onClick={this.props.togglePlayStatus.bind(this)}
        ></span>
        <span
          className="next"
          onClick={this.changePlay.bind(this, 'next')}
        ></span>
      </div>
    );
  }
